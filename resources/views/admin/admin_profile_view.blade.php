		...
		<div class="row">
			<div class="box box-widget widget-user">
				...
				<div class="widget-user-header bg-black">
				  <h3 class="widget-user-username">Admin Adı: {{ $adminData->name }}</h3>

				  <a href="{{ route('admin.profile.edit') }}" style="float: right;" class="btn btn-success rounded-0"> Profil Düzenle</a>
				  <h6 class="widget-user-desc">Admin E-posta:  {{ $adminData->email }}</h6>
				</div>
